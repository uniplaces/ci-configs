...
class Uniplaces_Sniffs_PHP_ForbiddenFunctionsSniffTest extends PHPUnit_Framework_TestCase
{
    public function testProcessPrevTNSSeparator()
    {
        ...
        $codeSnifferFile->shouldReceive('getTokens')->andReturn([['type' => 'T_STRING', 'content' => '->', 'code' => T_NS_SEPARATOR], ['type' => 'T_STRING', 'content' => 'sprintf'], ['type' => 'T_STRING', 'content' => 'test', 'code' => T_NS_SEPARATOR]]);
